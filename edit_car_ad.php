...
$page_title = "Edit Car Ad - PakWheels";
$ad_id = isset($_GET['id']) ? intval($_GET['id']) : 0;
$user_id = $_SESSION['user_id'];

$sql = "SELECT * FROM car_ads WHERE id = $ad_id AND user_id = $user_id LIMIT 1";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $car_info = mysqli_real_escape_string($conn, $_POST['car_info']);
    ...
    if (mysqli_query($conn, $sql_update)) {
        header("Location: ad_details.php?id=$ad_id&type=car");
        exit;
    } else {
        $message = "Failed to update car ad!";
        $message_type = "danger";
    }
}
...
<head>
    ...
    <link rel="stylesheet" href="assets/css/edit_car_ad.css">
    <title>Edit Car Ad - PakWheels</title>
</head>
    ...
    <div class="container py-5">
        <div class="page-header">
            <h2 class="page-title">
                ...
                <span>Edit Car Ad</span>
            </h2>
            <a href="<?php echo $base_path; ?>ad_details.php?id=<?php echo $ad_id; ?>&type=car" class="back-btn">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Car Info<span class="required-star">*</span></label>
                        <input type="text" name="car_info" class="form-control"
                            placeholder="e.g., Honda Civic 2020"
                            value="<?php echo htmlspecialchars($ad['car_info']); ?>" required>
                    </div>
                    <div class="col-md-6 mb-3">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Registered In<span class="required-star">*</span></label>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Exterior Color<span class="required-star">*</span></label>
                        <input type="text" name="exterior_color" class="form-control"
                            placeholder="e.g., Red, Black, White"
                            value="<?php echo htmlspecialchars($ad['exterior_color']); ?>" required>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Mileage (KM)<span class="required-star">*</span></label>
                ...
                <div class="mb-3">
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="whatsapp">
                            <i class="fab fa-whatsapp whatsapp-icon"></i> Enable WhatsApp Contact
                        </label>
                    </div>
                </div>
                ...
                <p class="helper-text">
                    ...
                    <span>Leave blank to keep existing images. Upload new images to replace them.</span>
                </p>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            ?>
                                <div class="image-preview">
                                    <img src="uploads/ads/cars/<?php echo htmlspecialchars($ad[$img_field]); ?>" alt="Car Image">
                                </div>
                            <?php endif; ?>
                ...
                <div class="action-buttons">
                    <button type="submit" class="submit-btn">
                        ...
                        <span>Update Car Ad</span>
                    </button>
                    <a href="<?php echo $base_path; ?>ad_details.php?id=<?php echo $ad_id; ?>&type=car" class="cancel-btn">
                        Cancel
                    </a>
                </div>
            </form>
