...
$css_path = $base_path;
$page_title = "Sell Your Car - PakWheels";
...
$colors = ['White', 'Black', 'Silver', 'Grey', 'Red', 'Blue', 'Green', 'Brown', 'Gold', 'Beige', 'Other'];
...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
    ...
    if (empty($car_info) || empty($description) || empty($vehicle_condition)) {
        ...
        $stmt = $conn->prepare("INSERT INTO car_ads (user_id, city, car_info, registered_in, exterior_color, vehicle_condition, mileage, price, description, mobile_number, secondary_number, whatsapp_enabled, image_1, image_2, image_3, image_4, image_5) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
...
<head>
    ...
    <link rel="stylesheet" href="assets/css/post_car_ad.css">
    <title>Sell Your Car - PakWheels</title>
</head>
...
<body>
    ...
    <div class="container py-5">
        ...
        <div class="text-center mb-5 hero-section">
            <h1 class="display-5 fw-bold gradient-heading">Sell your Car With 3 Easy & Simple Steps!</h1>
            ...
            <div class="row mt-5">
                <div class="col-md-4 mb-4">
                    <div class="step-card">
                        ...
                        <h5 class="mt-3">Enter Your Car Information</h5>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="step-card">
        ...
        <form method="POST" enctype="multipart/form-data" id="carForm">
            ...
            <div class="card custom-card shadow-lg mb-4">
                <div class="card-header gradient-header-primary">
                    <h4 class="mb-0"><i class="fas fa-car me-2"></i>Car Information</h4>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <small class="text-muted">Is this car brand new or used?</small>
                        </div>
                    </div>

                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold gradient-label">Car Info *</label>
                            <input type="text" name="car_info" class="form-control form-control-lg custom-input"
                                placeholder="e.g. Toyota Corolla 2018" required maxlength="200">
                            <small class="text-muted">Make/Model/Version</small>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold gradient-label">Exterior Color *</label>
                            <select name="exterior_color" class="form-select form-select-lg custom-select" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <small class="text-danger">Enter valid mileage (1-1000000)</small>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <small class="text-danger">Enter valid Price</small>
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-bold gradient-label">Ad Description *</label>
                        <textarea name="description" class="form-control custom-textarea" rows="5"
                            placeholder="Describe your car... (e.g., First owner, genuine parts, maintained by authorized workshop, excellent mileage etc.)"
                            required maxlength="982"></textarea>
                        <div class="text-end">
                            <small class="text-muted">Remaining Characters: <span id="charCount" class="gradient-text-primary">982</span></small>
                        </div>
                    </div>
